...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template name="main">
      ...
      <div class="form-group col-lg-5">
        <label for="BLOG_ROLE_EMAIL">Email Address</label>
        <input type="text" class="form-control" name="BLOG_ROLE_EMAIL" id="BLOG_ROLE_EMAIL" />
      </div>
      <div class="form-group col-lg-5">
        <label for="BLOG_ROLE_TYPE">Type of Role</label>
        <div class="styled-select">
					<select class="form-control" name="BLOG_ROLE_TYPE" id="BLOG_ROLE_TYPE">
	          <option />
      ...
      <div class="form-group col-lg-2">
        <label for="BLOG_ROLE_ADD">Create Role</label>
        <div>
					<button class="btn btn-primary" name="BLOG_ROLE_ADD" id="BLOG_ROLE_ADD" onclick="javascript:addRole();submitForm();">Add User</button>
				</div>
      </div>
    </div>
		<hr  />
		<div class="row">
			<div class="form-group col-lg-4">
				<xsl:call-template name="roles">
					...
					<xsl:with-param name="label_id" select="'BLOG_ROLE_EMAIL_RECIPIENTS'" />
			...
			<div class="form-group col-lg-4">
				<xsl:call-template name="roles">
					...
					<xsl:with-param name="label_id" select="'BLOG_ROLE_MANAGERS'" />
			...
			<div class="form-group col-lg-4">
				<xsl:call-template name="roles">
					...
					<xsl:with-param name="label_id" select="'BLOG_ROLE_ADMINS'" />
